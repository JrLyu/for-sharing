...
#收件人邮箱
receiver_1 = "Ziyuan Wu"
areceiver= f"{receiver_1}<wzy2020bj@sina.com>"
#抄送人邮箱
accer = "Jiuru Lyu"
acc = f'{accer}<lvjiuru@hotmail.com>'
#邮件主题
asubject = 'This is an email from Python.' 
wishes = "Best Regards"
...
#邮件正文
body = f"Dear {receiver_1}, \n\nThis emial is automatically generated by Python 3.6 on Visual Studio Code. \n\nYou are receiving this email becuase the sender thinks you should start to learn some coding skills. Please do not reply to this email as the sender will not check the inbox regularly. \n\nStart learning some coding skills right now. Hope you enjoy your Tuesday. \n\n{wishes},\nJiuru Lyu"
