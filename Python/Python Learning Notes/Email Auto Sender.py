...
#邮件正文
body = f"Dear {receiver_1}, \n\nThis emial is automatically generated by Python 3.6 on Visual Studio Code. \n\nYou are receiving this email becuase the sender thinks you should start to learn some coding skills. Reply to this email with evidence of your progress. \n\nThank you. Hope you enjoy your Thursday. \n\n{wishes},\nJiuru Lyu"
