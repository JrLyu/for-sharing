...
\begin{df}[Triple Integral]
	Find a bounded function $f(x,y,z)$ defined on a rectangular box, $B:\begin{cases}x_1\leq x\leq x_2\\y_1\leq y\leq y_2\\ z_1\leq z\leq z_2\end{cases},$ then, the triple integral on that box in defined as 	\[\iiintB f(x,y,z)\ \d V=\int_{z_1}^{z_2}\int_{y_1}^{y_2}\int_{x_1}^{x_2}f(x,y,z)\ \dx\d y\d z.\]
\end{df}
\begin{thm}
