...
\def\vecr{\va{{\textbf{r}}}}
\def\vecn{\va{n}}
\def\vece{\vu{\boldsymbol{\textbf{e}}}}
...
\begin{df}[Simply Connected Regions]
Simply connected regions are regions that every simple closed curves in $D$ enclosed only points that are in $D$.
\end{df}
\begin{center}
\tikzset{every picture/.style={line width=0.75pt}}
\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
...
\end{rmk}
\begin{thm}[Extension of Green's Theorem 1]
	We can extend Green's Theorem to finite union of simply connected regions:
	\begin{center}
	\tikzset{every picture/.style={line width=0.75pt}}
	\begin{tikzpicture}[x=0.65pt,y=0.65pt,yscale=-1,xscale=1]
	\draw    (122.37,190.27) -- (206.37,201.27) ;
	\draw [shift={(170.32,196.55)}, rotate = 187.46] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-4.9) .. controls (6.95,-2.3) and (3.31,-0.67) .. (0,0) .. controls (3.31,0.67) and (6.95,2.3) .. (10.93,4.9)   ;
	\draw    (122.37,190.27) .. controls (162.37,160.27) and (210.37,132.27) .. (275.37,133.27) .. controls (340.37,134.27) and (202.37,173.27) .. (206.37,201.27) .. controls (210.37,229.27) and (282.37,242.27) .. (257.37,261.27) .. controls (232.37,280.27) and (97.37,215.27) .. (122.37,190.27) -- cycle ;
	\draw [shift={(187.99,150.79)}, rotate = 337.38] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
	\draw [shift={(260.6,158.77)}, rotate = 152.64] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
	\draw [shift={(231.33,227.85)}, rotate = 31.07] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
	\draw [shift={(182.44,247.66)}, rotate = 204.77] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
	\draw    (122.37,190.27) -- (172.37,197.27) ;
	\draw [shift={(140.44,192.8)}, rotate = 7.97] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
	\draw (244,114.4) node [anchor=north west][inner sep=0.75pt]    {$C_{1}$};
	\draw (173,256.4) node [anchor=north west][inner sep=0.75pt]    {$C_{2}$};
	\draw (154,174.4) node [anchor=north west][inner sep=0.75pt]    {$C_{3}$};
	\draw (200,156.4) node [anchor=north west][inner sep=0.75pt]    {$D_{1}$};
	\draw (189,224.4) node [anchor=north west][inner sep=0.75pt]    {$D_{2}$};
	\end{tikzpicture}	
	\end{center}
 \[\intC P\dx+Q\dy=\iintD\pdv{Q}{x}-\pdv{P}{y}\ \dA.\]
	\begin{prf}
		Let $I=\intC P\dx+Q\dy.$ Then, \[\begin{aligned}I&=\int_{C_1\cup C_3}P\dx+Q\dy+\int_{C_2\cup(-C_3)}P\dx+Q\dy\\&=\iint_{D_1}\pdv{Q}{x}-\pdv{P}{y}\ \dA+\iint_{D_2}\pdv{Q}{x}-\pdv{P}{y}\ \dA\\&=\iintD\pdv{Q}{x}-\pdv{P}{y}\ \dA.\end{aligned}\]
	\end{prf}
\end{thm}
\begin{thm}[Extension of Green's Theorem 2]
	Green's Theorem can be applied to regions with holes (regions that are not simply connected): \[\intC P\dx+Q\dy=\iintD\pdv{Q}{x}-\pdv{P}{y}\ \dA.\]
\end{thm}
\begin{eg}
	Evaluate $\ointC y^2\dx+3xy\dy$ along $C$ as the following: 
	\begin{center}
	\tikzset{every picture/.style={line width=0.75pt}}
	\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
	\draw  (50,198.27) -- (211.37,198.27)(131.37,113.22) -- (131.37,209.22) (204.37,193.27) -- (211.37,198.27) -- (204.37,203.27) (126.37,120.22) -- (131.37,113.22) -- (136.37,120.22)  ;
	\draw   (96.37,198.27) .. controls (96.37,181.7) and (112.04,168.27) .. (131.37,168.27) .. controls (150.7,168.27) and (166.37,181.7) .. (166.37,198.27) .. controls (166.37,198.27) and (166.37,198.27) .. (166.37,198.27) -- cycle ;
	\draw   (74.87,198.27) .. controls (74.87,198.27) and (74.87,198.27) .. (74.87,198.27) .. controls (74.87,171.53) and (100.16,149.84) .. (131.37,149.84) .. controls (162.57,149.84) and (187.87,171.53) .. (187.87,198.27) -- cycle ;
	\draw (124,151.4) node [anchor=north west][inner sep=0.75pt]    {$D$};
	\draw (163,137.4) node [anchor=north west][inner sep=0.75pt]    {$x^{2} +y^{2} =4$};
	\draw (46,201.4) node [anchor=north west][inner sep=0.75pt]    {$x^{2} +y^{2} =1$};
	\draw (212,200.4) node [anchor=north west][inner sep=0.75pt]    {$x$};
	\draw (111,110.4) node [anchor=north west][inner sep=0.75pt]    {$y$};
	\end{tikzpicture}
	\end{center}
	\begin{ans}
		Use the extension of the Green's Theorem: \[I=\ointC y^2\dx+3xy\dy=\iintD(3y-2y)\ \dA=\iintD y\ \dA.\]\par Change to polar coordinates: $1\leq r\leq2,\quad 0\leq\theta\leq\pi,\quad y=r\sin\theta.$\[\begin{aligned}I=\int_0^\pi\int_1^2r\sin\theta\cdot r\ \d r\d\theta&=\int_0^\pi\sin\theta\ \d\theta\int_1^2r^2\ \d r\\&=\qty\Big[-\cos\theta]_0^\pi\qty[\dfrac{1}{3}r^3]_1^2\\&=(-(-1)-(-1))\qty(\dfrac{8}{3}-\dfrac{1}{3})\\&=2\qty(\dfrac{7}{3})=\dfrac{14}{3}.\end{aligned}\]
	\end{ans}
\end{eg}
\begin{eg}
	Evaluate $\ointC \qty(x^2-xy)\dx+\qty(xy-x^2)\dy,$ where $C$ is given by the following triangle.
	\begin{center}
	\tikzset{every picture/.style={line width=0.75pt}}
	\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
	\draw  (45,161) -- (203.37,161)(60.84,71) -- (60.84,171) (196.37,156) -- (203.37,161) -- (196.37,166) (55.84,78) -- (60.84,71) -- (65.84,78)  ;
	\draw    (60.84,161) -- (120.37,100.27) ;
	\draw [shift={(94.8,126.35)}, rotate = 134.43] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-4.9) .. controls (6.95,-2.3) and (3.31,-0.67) .. (0,0) .. controls (3.31,0.67) and (6.95,2.3) .. (10.93,4.9)   ;
	\draw    (120.37,100.27) -- (179.37,161.27) ;
	\draw [shift={(154.04,135.09)}, rotate = 225.95] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-4.9) .. controls (6.95,-2.3) and (3.31,-0.67) .. (0,0) .. controls (3.31,0.67) and (6.95,2.3) .. (10.93,4.9)   ;
	\draw    (60.84,161) -- (179.37,161.27) ;
	\draw [shift={(113.1,161.12)}, rotate = 0.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-4.9) .. controls (6.95,-2.3) and (3.31,-0.67) .. (0,0) .. controls (3.31,0.67) and (6.95,2.3) .. (10.93,4.9)   ;
	\draw  [fill={rgb, 255:red, 155; green, 155; blue, 155 }  ,fill opacity=0.31 ] (119.87,100.27) -- (179.37,161.27) -- (60.84,161.27) -- cycle ;
	\draw (204,162.4) node [anchor=north west][inner sep=0.75pt]    {$x$};
	\draw (41,65.4) node [anchor=north west][inner sep=0.75pt]    {$y$};
	\draw (22,162.4) node [anchor=north west][inner sep=0.75pt]    {$( 0,0)$};
	\draw (156,165.4) node [anchor=north west][inner sep=0.75pt]    {$( 2,0)$};
	\draw (114,81.4) node [anchor=north west][inner sep=0.75pt]    {$( 1,1)$};
	\draw (112,129.4) node [anchor=north west][inner sep=0.75pt]    {$D$};
	\end{tikzpicture}
	\end{center}
	\begin{ans}
		This question is left as an exercise so the steps are omitted, but the answer should be \[I=-\dfrac{4}{3}.\]
	\end{ans}
\end{eg}
