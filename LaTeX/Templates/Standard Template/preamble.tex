...
\newenvironment*{thm}[1]{\begin{tcolorbox}{\textbf{Theorem \thesubsection.\stepcounter{index}\theindex\ {#1}}}\par}{\par\end{tcolorbox}}
...
\newenvironment*{clm}{\par\noindent\textbf{Claim \thesection.\stepcounter{index}\theindex}}{\par}
