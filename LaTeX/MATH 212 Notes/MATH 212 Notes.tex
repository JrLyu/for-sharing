...
\begin{eg}
	Logistic Growth \par 
	The \textit{logistic growth} is modeled by the differential equation \[y'=r\qty(1-\dfrac{y}{K})y,\] where $r>0$ represents the intrinsic growth rate in absence of limiting factors, and $K>0$ is the environmental carrying capacity. 
\end{eg}
