...
\begin{eg}
	...
	\begin{figure}[H]\centering
		$\qquad$\subfigure{\includegraphics[width=0.3\textwidth]{fig/overdamping1}}\label{overdamping1}
		\hfill
		\subfigure{\includegraphics[width=0.45\textwidth]{fig/overdamping2}}\label{overdamping2}$\qquad$
		\caption{Overdamping}
	\end{figure}\par 
